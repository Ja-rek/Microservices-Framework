...
{
    /// <summary>
    /// Checks if a value is a positive number and throws an exception if it is.
    /// </summary>
    /// <typeparam name="T">The type of the value to be checked.</typeparam>
    /// <param name="value">The value to be checked for positivity.</param>
    ...
    /// <exception cref="Exception">Thrown if the value is a positive number.</exception>
        ...
        where T : struct, IComparable, IConvertible
    {
        ...
        {
            var exception = Create<T>($"shouldn't be a positive number", message, id, valueName, idName);
            if (exception != null)
            {
                throw exception;
            }
