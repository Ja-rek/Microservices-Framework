...
namespace MicroservicesFramework.Tracing.Jaeger.Masstransit.UnitTests;
...
public class AddMasstransitToJaegarTests
{
    ...
    public void SetUp()
    {
        services = WebApplication.CreateBuilder()
            .Services;
    ...
    public void AddMasstransitToJaegar_WhenEndpointAndProtocolAreValid_Succeeds()
    {
        ...
        // Act & Assert
        services.AddMasstransitToJaegar();
    ...
    public void AddMasstransitToJaegar_WhenEndpointAndProtocolAreValid_ThrowsNoException()
    {
        ...
        // Act & Assert
        Assert.DoesNotThrow(() => services.AddMasstransitToJaegar());
    }
    ...
    public void AddMasstransitToJaegar_WhenEndpointIsNull_ThrowsInvalidOperationException()
    {
        ...
        // Act & Assert
        Assert.Throws<InvalidOperationException>(() => services.AddMasstransitToJaegar());
    }
    ...
    public void AddMasstransitToJaegar_WhenEndpointIsInvalid_ThrowsUriFormatException()
    {
        ...
        // Act & Assert
        Assert.Throws<UriFormatException>(() => services.AddMasstransitToJaegar());
    }
